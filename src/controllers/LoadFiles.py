...
class Aplicacion:
    ...
    def guardar(self,scroll):
        ...
        nombrearch=fd.asksaveasfilename(initialdir = "/",title = "Guardar como",filetypes = (("json files","*.json"),("todos los archivos","*.*")))
        if nombrearch!='':
    ...
    def recuperar(self,scroll):
        self.scrolledtext1=scroll
        nombrearch=fd.askopenfilename(initialdir = "/",title = "Seleccione archivo",filetypes = (("json files","*.json"),("todos los archivos","*.*")))
        if nombrearch!='':
